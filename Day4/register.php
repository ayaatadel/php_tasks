...
<body>
 ...
 <h1 class="text-primary m-auto w-75 my-3">Register Form</h1>
    
<!-- form -->
 <?php 
 if(isset($_GET['message']))
 {
  echo "<p class='alert alert-danger w-50 m-auto text-center'>". $_GET['message'] ."</p>";
 }
 ?>
<form class="w-50 m-auto my-5"  action="server.php" method="post" >
  <div class="mb-3">
